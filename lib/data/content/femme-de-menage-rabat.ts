  ...
  sections: [
    {
      ...
      content: `<p>On pourrait penser que les deux plus grandes villes du Maroc fonctionnent pareil. Faux. Rabat a une structure sociale et économique particulière qui change tout.</p>
...
<p>Autre particularité rbatie : le bouche-à-oreille fonctionne extrêmement bien dans les quartiers résidentiels. Agdal, Souissi, Hay Riad forment des communautés assez homogènes où tout le monde se connaît, et une employée recommandée par une voisine de confiance vaut mieux qu'une annonce en ligne.</p>`,
    ...
    {
      title: "Agdal, Souissi, Hay Riad : les quartiers les plus demandés",
      content: `<p>Pas de surprise : les quartiers aisés concentrent la demande. Mais chacun a sa personnalité.</p>

<p><strong>Agdal</strong> est le quartier des cadres, des professions libérales et des familles de classe moyenne supérieure. Appartements spacieux, jeunes couples avec enfants, besoin de ménage régulier 2-3 fois par semaine. Les salaires proposés sont corrects sans être exceptionnels : autour de 1 500 à 2 200 DH par mois pour 20 heures hebdomadaires.</p>

<p><strong>Souissi</strong> est un autre monde. C'est le quartier des ministres, des ambassades, des grandes villas avec piscine. Les besoins sont importants (propriétés de 400 à 800 m²) et les attentes très élevées : une employée doit souvent savoir entretenir des surfaces spéciales, gérer des argenteries, des étoffes de qualité, des équipements haut de gamme. En échange, les salaires peuvent dépasser 4 000 DH/mois pour un temps plein, parfois avec logement.</p>
...
<p><strong>Ryad (nouveau quartier)** et les extensions vers Sala** : quartiers en développement avec une classe moyenne qui monte, demande croissante mais moindre pouvoir de négociation côté employeur.</p>`,
    ...
    {
      title: "Tarifs femme de ménage Rabat vs Casablanca",
      content: `<p>Voici une réalité que beaucoup ignorent : Rabat est souvent légèrement moins cher que Casablanca pour le ménage, sauf dans les quartiers ultra-premium comme Souissi où c'est l'inverse.</p>

<p>Pourquoi ? Casablanca a une densité de population bien supérieure, donc plus de demande, donc des prix qui montent. À Rabat, le marché est plus calme, les distances sont plus courtes, et beaucoup d'employées viennent des quartiers périphériques (Salé, Temara, Hay Nahda) avec des coûts de transport inférieurs.</p>

<p>En pratique, pour une journée de ménage (6-7 heures) à Rabat :</p>
<ul>
<li>Agdal, Hassan, Hay Riad : 150 à 200 DH la journée</li>
<li>Souissi, Pinède, quartiers diplomatiques : 200 à 300 DH la journée</li>
<li>Temara, Salé, périphérie : 120 à 160 DH</li>
</ul>

<p>Pour un temps plein mensuel (6 jours/semaine) :</p>
<ul>
<li>Agdal et équivalents : 2 000 à 2 800 DH</li>
<li>Souissi et villas : 2 800 à 4 500 DH (voire plus si logement fourni)</li>
</ul>

<p>À comparer avec Casa où les mêmes prestations tournent entre 2 200 et 5 500 DH selon le quartier. La différence est là.</p>`,
    },
    {
...
<p><strong>Rabat spécifique</strong> : les agences CNSS les plus accessibles pour les quartiers résidentiels sont celle d'Agdal (Avenue Al Jazair) et celle de Hay Riad. Comptez une demi-journée pour les formalités initiales, ensuite tout se gère en ligne.</p>`,
    },
    {
      title: "Trouver une femme de ménage fiable à Rabat : les bonnes méthodes",
      content: `<p>À Rabat plus qu'ailleurs, le réseau personnel reste le canal le plus efficace. Mais tous les réseaux ne se valent pas.</p>

<p><strong>Le bouche-à-oreille entre voisins</strong> : dans les immeubles et résidences d'Agdal ou Hay Riad, il suffit souvent de poser la question dans le groupe WhatsApp de la résidence. Vous aurez des recommandations directes d'employées qui ont déjà fait leurs preuves dans le même type d'environnement.</p>
...
<p><strong>La période d'essai</strong> : légalement, elle est de 45 jours pour les travailleurs domestiques selon la loi 19-12. Utilisez-la à fond pour évaluer la fiabilité, la discrétion et la qualité du travail avant de vous engager sur le long terme.</p>`,
  ...
  priceTable: [
    { intervention: "Ménage à la journée (6-7h) – Agdal, Hay Riad", prixMin: 150, prixMoyen: 175, prixMax: 200 },
    { intervention: "Ménage à la journée – Souissi, villas diplomatiques", prixMin: 200, prixMoyen: 250, prixMax: 300 },
    { intervention: "Demi-journée ménage (3-4h)", prixMin: 90, prixMoyen: 110, prixMax: 140 },
    { intervention: "Temps plein mensuel – appartement (Agdal/Hay Riad)", prixMin: 1800, prixMoyen: 2300, prixMax: 2800 },
    { intervention: "Temps plein mensuel – villa (Souissi/Pinède)", prixMin: 2800, prixMoyen: 3500, prixMax: 4500 },
    { intervention: "Repassage seul (à l'heure)", prixMin: 30, prixMoyen: 40, prixMax: 55 },
  ...
  externalLinks: [
    {
      ...
      description: "Portail officiel pour déclarer votre aide ménagère et payer les cotisations sociales",
    },
    {
      label: "Loi 19-12 relative aux conditions de travail des employés de maison",
      url: "https://www.emploi.gov.ma",
      description: "Texte intégral de la loi sur les travailleurs domestiques – Ministère de l'Emploi",
    },
    {
      label: "ANAPEC – Agence Nationale de Promotion de l'Emploi",
      url: "https://www.anapec.org",
      description: "Recrutement légal et placement de personnel de maison qualifié",
    },
  ],
  testimonials: [
    {
    ...
    },
    {
      ...
      city: "Rabat",
      rating: 5,
      text: "Villa familiale à Souissi, 500m² sur deux niveaux. On cherchait quelqu'un d'expérimenté pour les surfaces nobles (parquet, marbres). La personne recommandée connaissait parfaitement son travail et traite la maison avec le même soin qu'on le ferait soi-même.",
      date: "Janvier 2026",
      service: "Entretien villa temps plein",
    },
    {
      name: "Amina R.",
      quarter: "Hay Riad",
      city: "Rabat",
      rating: 4,
      text: "Première expérience avec une aide ménagère déclarée en CNSS. Allo Maison m'a guidée sur toutes les démarches. La plateforme est vraiment utile pour quelqu'un qui ne connaît pas le système.",
      date: "Mars 2026",
      service: "Ménage + déclaration CNSS",
    },
  ],
  faqs: [
    {
      question: "Quel est le salaire minimum légal pour une femme de ménage à Rabat ?",
      answer: "Selon la loi 19-12, le salaire minimum pour un travailleur domestique à temps plein est de 2 030 DH nets par mois en 2026. Ce minimum peut être dépassé selon les compétences, l'expérience et le quartier. Dans les villas de Souissi, il est très rare de payer le minimum légal.",
    },
    {
      question: "Est-ce que les prix à Rabat sont différents de Casablanca ?",
      answer: "Oui, légèrement. Hors quartiers diplomatiques, Rabat est en général 10 à 15% moins cher que Casablanca pour le ménage à domicile. La densité de demande est plus faible et les employées viennent souvent de zones périphériques avec des coûts de transport inférieurs.",
    },
    {
      question: "Comment trouver une femme de ménage pour une villa à Souissi ?",
      answer: "Le réseau de recommandation est roi à Souissi. Parlez à vos voisins, à votre agence immobilière, ou passez par une plateforme spécialisée comme Allo Maison qui vérifie les profils. Pour les maisons diplomatiques, certaines agences de placement spécialisées opèrent à Rabat et ont l'habitude des exigences spécifiques.",
    },
    {
      question: "Une ambassade peut-elle demander un casier judiciaire à une employée de maison ?",
      answer: "Oui, c'est légal et courant pour les postes dans les résidences diplomatiques. Le casier judiciaire (bulletin numéro 3) peut être demandé comme condition d'embauche. L'employée peut l'obtenir auprès du tribunal de première instance ou en ligne sur le portail justice.gov.ma.",
    },
    {
    ...
    },
    {
      ...
      answer: "Selon la loi 19-12 : 18 jours de congés annuels payés après un an d'ancienneté (1,5 jour/mois), les jours fériés légaux (Aid al-Fitr, Aid al-Adha, Aïd al-Mawlid, etc.), et les congés maladie justifiés. En cas de décès d'un proche, un congé spécial de 3 jours est prévu.",
    },
    {
      question: "Comment se passe la rupture de contrat avec une femme de ménage à Rabat ?",
      answer: "La loi prévoit un préavis qui varie selon l'ancienneté : 8 jours jusqu'à 6 mois, 1 mois entre 6 mois et 2 ans, 2 mois au-delà de 2 ans. En cas de licenciement sans faute grave, une indemnité de rupture est due. Les détails sont dans la loi 19-12 article 15 et suivants.",
    },
    {
      question: "Peut-on loger une femme de ménage à domicile à Rabat ?",
      answer: "Oui, c'est légal et pratiqué dans les grandes villas, surtout à Souissi. Dans ce cas, la valeur du logement peut être prise en compte dans la rémunération, mais ne peut pas remplacer entièrement le salaire en espèces. La loi prévoit que la nourriture et le logement fournis ne peuvent dépasser 50% du salaire.",
    },
    {
    ...
    },
    {
      ...
      answer: "Oui. L'OFPPT propose des formations courtes pour le personnel de maison, et certaines associations comme l'ADFM (Association Démocratique des Femmes du Maroc) organisent des sessions pratiques. L'ANAPEC peut orienter vers ces formations. Une employée formée vaut souvent mieux et peut légitimement demander un salaire supérieur.",
    },
  ],
  tips: [
