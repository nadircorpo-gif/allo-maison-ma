...
<p>Il y a aussi une dimension sociale importante. Dans les vieux quartiers de Casablanca — Maarif, Gautier, Bourgogne — le concierge est souvent un repère pour les personnes âgées, un intermédiaire de confiance dans la vie du quartier, quelqu'un qui connaît tout le monde et qui crée un tissu social dans l'immeuble. C'est une valeur qu'on ne mesure pas facilement mais qu'on ressent immédiatement quand elle est absente.</p>`,
    },
    {
      ...
      content: `<p>Ne pas confondre les deux. Les compétences, les responsabilités et les salaires ne sont pas les mêmes.</p>

<p><strong>Le concierge d'immeuble</strong> gère des parties communes dans un contexte collectif. Il interagit avec de multiples copropriétaires, doit maintenir une neutralité entre voisins qui ne s'entendent pas toujours, et répond devant un syndic ou une assemblée de copropriétaires. Il doit gérer des situations conflictuelles avec tact et avoir un minimum de compétences relationnelles.</p>

<p>Les responsabilités typiques : nettoyage des couloirs et escaliers, gestion des déchets, surveillance de l'accès, entretien basique des espaces verts, signalement des pannes aux prestataires, réception des livraisons, et dans les grands immeubles, parfois la gestion du chauffage collectif ou du parking.</p>
...
<p><strong>Le syndic</strong> est le gestionnaire de la copropriété. Il peut être un syndic professionnel (agence immobilière, cabinet de gestion) ou un syndic bénévole (un des copropriétaires élu par l'assemblée générale). Ses responsabilités incluent : maintenance des parties communes, paiement des prestataires, convocation des assemblées générales, et employeur officiel du concierge.</p>

<p><strong>L'employeur du concierge</strong> au sens légal, c'est le syndic (ou la copropriété). Cela a des implications pratiques importantes : le contrat de travail est signé par le syndic, les cotisations CNSS sont payées par la copropriété sur les charges communes, et en cas de litige, c'est le syndic qui représente l'employeur devant le tribunal.</p>

<p><strong>Le règlement de copropriété</strong> définit les droits et obligations de chaque partie, incluant parfois des détails sur le rôle du gardien. Si vous achetez dans un immeuble avec concierge, vérifiez que son statut est clairement défini dans ce document.</p>

<p>La réalité à Casablanca : une grande majorité d'immeubles fonctionnent sans syndic officiel, sans assemblée générale, et avec des gardiens payés de main à main. C'est illégal mais courant. Les problèmes (litige avec le gardien, accident dans les parties communes, impayés de charges) montrent leurs conséquences au moment où on s'y attend le moins.</p>`,
    },
    {
      title: "Tarifs concierge Casablanca 2026",
      content: `<p>Le salaire d'un concierge à Casablanca dépend de plusieurs facteurs : taille et standing de l'immeuble, quartier, responsabilités, et si un logement est fourni.</p>

<p>Pour un immeuble standard de 20 à 30 appartements dans un quartier intermédiaire (Hay Mohammadi, Sidi Bernoussi, Bernoussi) : entre 1 800 et 2 500 DH/mois hors logement. Si un logement est fourni (loge dans l'immeuble), le salaire cash peut être réduit de 300 à 600 DH selon la valeur du logement.</p>

<p>Pour une résidence fermée moderne de 50 à 100 appartements dans un quartier huppé (Ain Diab, Anfa, CIL) : entre 3 000 et 5 000 DH/mois selon les responsabilités. Ces résidences ont souvent plusieurs concierges en rotation et parfois des agents de sécurité supplémentaires la nuit.</p>
...
<p>Une chose importante : le SMIG (salaire minimum interprofessionnel garanti) au Maroc en 2026 est d'environ 3 111 DH bruts par mois pour les secteurs non agricoles. Un concierge payé 1 800 DH sans logement ne satisfait pas légalement le SMIG. Avec un logement évalué à 500 DH (ce qui est bas), ça fait 2 300 DH — encore en dessous. Beaucoup d'immeubles casablancais fonctionnent dans l'illégalité salariale sans le savoir.</p>`,
    },
    {
      ...
      content: `<p>Le concierge n'est pas un super-héros et ne peut pas être tenu responsable de tout. Mais ses responsabilités légales sont réelles et souvent mal comprises des deux côtés.</p>

<p><strong>Responsabilité en cas d'accident dans les parties communes</strong> : si quelqu'un glisse dans l'escalier à cause d'un sol non nettoyé ou mal signalé, la responsabilité peut être partagée entre le syndic (qui doit maintenir les parties communes sûres) et le concierge (si la négligence est établie dans l'exercice de ses fonctions). D'où l'importance d'un contrat clair qui définit ses horaires et ses tâches.</p>

<p><strong>Vol dans l'immeuble</strong> : si un appartement est cambriolé pendant les heures de service du concierge et que sa négligence est prouvée (porte laissée ouverte, visiteur non contrôlé), il peut être impliqué dans la procédure. Encore une fois, son contrat doit préciser ses obligations de surveillance.</p>
...
<p><strong>La période d'essai</strong> : selon le code du travail marocain, elle est de 15 jours pour les employés de catégorie ouvriers, 45 jours pour les employés, et 3 mois pour les cadres. Un concierge standard est en catégorie ouvrière — 15 jours, c'est court mais suffisant pour voir les bases.</p>`,
    },
    {
      ...
      content: `<p>La demande de concierges suit logiquement la densité de construction d'immeubles collectifs et le niveau de standing des résidences.</p>

<p><strong>Maarif et Gauthier</strong> : quartiers anciens avec de nombreux immeubles Art Déco et années 60-70, souvent en copropriété complexe. Beaucoup de ces immeubles n'ont pas eu de gardien pendant des années et s'en trouvent dans un état lamentable. Demande croissante depuis que des copropriétaires commencent à s'organiser.</p>

<p><strong>Hay Hassani et Sidi Maarouf</strong> : quartiers de classe moyenne avec des immeubles plus récents et des résidences fermées qui intègrent souvent dès la construction un poste de gardien. Demande stable et régulière.</p>

<p><strong>Ain Diab, Californie et Anfa</strong> : résidences haut de gamme avec des niveaux de service élevés. Les concierges de ces zones doivent souvent parler français correctement, avoir une présentation soignée et gérer des résidents exigeants. Salaires parmi les plus élevés de la ville.</p>
...
<p>L'interphone avec caméra à l'entrée, les badges d'accès et les portails motorisés remplacent progressivement le traditionnel "gardien qui ouvre la porte" dans les résidences modernes. Le concierge de demain à Casablanca sera autant un gestionnaire technique qu'un agent de présence physique.</p>`,
  ...
  priceTable: [
    { intervention: "Concierge immeuble standard (mensuel, logé)", prixMin: 1600, prixMoyen: 2000, prixMax: 2600 },
    { intervention: "Concierge immeuble standard (mensuel, non logé)", prixMin: 2200, prixMoyen: 2800, prixMax: 3500 },
    { intervention: "Concierge résidence haut de gamme (mensuel)", prixMin: 3000, prixMoyen: 4000, prixMax: 5500 },
    { intervention: "Gardien de villa (mensuel, logé)", prixMin: 1500, prixMoyen: 2000, prixMax: 2800 },
    { intervention: "Agent de sécurité nuit (8h, via société)", prixMin: 200, prixMoyen: 280, prixMax: 380 },
    { intervention: "Gardien parking (journée)", prixMin: 150, prixMoyen: 200, prixMax: 280 },
  ...
  externalLinks: [
    {
      ...
      description: "Texte officiel de la loi sur la copropriété au Maroc – Ministère de l'Habitat",
    },
    {
      label: "CNSS – Affilier un employé de maison ou concierge",
      url: "https://www.cnss.ma",
      description: "Démarches en ligne pour déclarer un concierge ou gardien à la CNSS",
    },
    {
      label: "Code du travail marocain – Dahir 65-99",
      url: "https://www.emploi.gov.ma",
      description: "Cadre légal du contrat de travail au Maroc applicable aux concierges",
    },
    {
      label: "Fédération Nationale des Promoteurs Immobiliers",
      url: "https://www.fnpi.ma",
      description: "Bonnes pratiques de gestion d'immeuble et de copropriété au Maroc",
    },
  ],
  testimonials: [
    {
      name: "Syndic Résidence Al Manar",
      quarter: "Hay Riad (Rabat)",
      city: "Rabat",
      rating: 5,
      text: "On cherchait un profil sérieux pour notre résidence de 45 appartements. Allo Maison nous a aidé à définir le poste, trouver des candidats vérifiés et préparer le contrat. Le concierge qu'on a recruté est là depuis 8 mois, zéro problème. La différence avec le précédent est énorme.",
      date: "Janvier 2026",
      service: "Recrutement concierge résidence",
    },
    {
      name: "Farouk B.",
      quarter: "Maarif",
    ...
    },
    {
      ...
      city: "Casablanca",
      rating: 5,
      text: "Notre villa de 600m² avec piscine avait besoin d'un gardien compétent, pas juste quelqu'un pour ouvrir le portail. Le profil trouvé via Allo Maison connaît les bases d'entretien (piscine, jardin, système d'irrigation), il est fiable et discret. Exactement ce qu'on cherchait.",
      date: "Décembre 2025",
      service: "Gardien villa haut de gamme",
    },
  ],
  faqs: [
    {
      question: "Qui est l'employeur légal d'un concierge dans un immeuble en copropriété ?",
      answer: "C'est le syndic de copropriété qui est l'employeur légal. Le contrat de travail est signé au nom de la copropriété, représentée par le syndic. Les cotisations CNSS et les salaires sont payés sur les charges communes de l'immeuble. Si votre immeuble n'a pas de syndic officiel, la situation est juridiquement floue et risquée.",
    },
    {
      question: "Que se passe-t-il si le concierge se blesse dans l'exercice de ses fonctions ?",
      answer: "S'il est déclaré à la CNSS, l'accident de travail est pris en charge par l'assurance accidents du travail CNSS. Les soins médicaux sont couverts et une indemnisation peut être versée selon la gravité. Si le concierge n'est pas déclaré, la copropriété (et solidairement les copropriétaires) peut être tenue responsable de la totalité des frais et des dommages.",
    },
    {
      question: "Le concierge peut-il sous-louer ou prêter sa loge à quelqu'un d'autre ?",
      answer: "Non. La loge est mise à disposition pour les besoins de la fonction, pas comme résidence personnelle que le concierge peut utiliser librement. Il peut y habiter avec sa famille proche (conjoint, enfants mineurs), mais sous-louer est interdit. Cette règle doit être écrite dans le contrat.",
    },
    {
    ...
    },
    {
      ...
      answer: "Oui, c'est une décision que l'assemblée générale peut prendre. Dans ce cas, toutes les règles du droit du travail s'appliquent : préavis, indemnité de licenciement selon l'ancienneté, régularisation des congés non pris. Si le concierge est logé, il faut aussi prévoir un délai raisonnable pour qu'il trouve un autre logement.",
    },
    {
      question: "La copropriété est-elle obligatoire d'avoir un concierge selon la loi 18-00 ?",
      answer: "Non, la loi 18-00 n'oblige pas les copropriétés à avoir un concierge. C'est une décision de gestion que l'assemblée générale prend souverainement selon les besoins et les ressources de la copropriété. En revanche, si un concierge existe, son statut doit être légalisé.",
    },
    {
      question: "Comment les charges du concierge sont-elles réparties entre copropriétaires ?",
      answer: "Selon les tantièmes (pourcentages) de copropriété définis dans le règlement de copropriété. Un copropriétaire qui possède 5% des parties communes paie 5% du salaire du concierge. Le syndic calcule ces charges trimestriellement ou annuellement et les intègre dans les appels de charges.",
    },
    {
      question: "Peut-on demander au concierge de faire des courses ou des services personnels ?",
      answer: "Non, sauf si c'est expressément prévu dans son contrat avec une compensation appropriée. Le concierge travaille pour la copropriété entière, pas pour un copropriétaire individuel. Lui demander des services personnels (garder vos enfants, faire vos courses) sans compensation est une exploitation. Si certains copropriétaires veulent des services supplémentaires, ils peuvent négocier directement et rémunérer séparément.",
    },
    {
    ...
    },
    {
      ...
      answer: "Oui, il peut refuser des tâches non prévues à son contrat ou des tâches dangereuses sans équipement approprié. Par exemple, refuser de nettoyer une fosse septique sans équipement de protection est légitime. En cas de refus injustifié de tâches contractuelles, le syndic doit gérer ça via un avertissement écrit avant toute sanction.",
    },
    {
      question: "Quelles sont les sanctions pour une copropriété qui ne déclare pas son concierge à la CNSS ?",
      answer: "La non-déclaration est passible d'amendes allant de 2 000 à 5 000 DH par employé non déclaré, plus le rappel de toutes les cotisations dues avec pénalités de retard. En cas de contrôle de l'inspection du travail (qui survient parfois sur signalement), les conséquences peuvent être significatives. Et en cas d'accident du concierge non déclaré, les copropriétaires peuvent être personnellement poursuivis.",
    },
  ],
  tips: [
