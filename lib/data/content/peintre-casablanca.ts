...
const content: RichPageContent = {
  ...
  h1: "Peintre Casablanca — Prix, Marques et Tout ce qu'il Faut Savoir en 2026",
  heroText:
    "Vous venez de signer le bail d'un appartement à Sidi Maarouf. L'ancien locataire avait des goûts particuliers — murs bordeaux, plafond gris foncé, et une salle de bain peinte en orange. Avant de poser un seul meuble, il faut tout repeindre. Mais par où commencer ? Quelle peinture ? Quel artisan ? Combien ça va coûter ? Ce guide vous accompagne de A à Z pour un chantier de peinture réussi à Casablanca.",
...
<p>Pour les artisans professionnels : beaucoup passent par des grossistes à Derb Omar ou dans la zone industrielle de Ain Sebaa où les prix de gros sont significativement moins chers. Quand vous demandez un devis, clarifiez si la peinture est incluse (fournie par l'artisan) ou si vous l'achetez vous-même.</p>`,
    },
  ],
  ...
  youtubeVideoTitle: "Comment préparer un mur avant de peindre — techniques professionnelles",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Standard : 1 sous-couche + 2 couches de finition, soit 3 couches au total. Si les murs sont en très bon état et que vous changez peu la couleur, 2 couches peuvent suffire. Si le mur est très poreux, très sombre, ou neufs, la sous-couche est indispensable. Les artisans qui vont vite font souvent 1 couche — le résultat se voit après 6 mois.",
    },
    {
