...
<p>Pour les propriétaires de riads en location, le conseil numéro un : <strong>faire faire une inspection complète de la plomberie avant chaque saison touristique</strong> (octobre avant l'hiver, avril avant l'été). Le coût d'une inspection préventive (400-600 DH) est dérisoire comparé à une intervention d'urgence en haute saison qui peut coûter 5 à 10 fois plus.</p>`,
    ...
    {
      title: "Problèmes spécifiques : calcaire et chaleur",
      content: `<p>Marrakech a une eau particulièrement chargée en calcaire. Si vous regardez votre robinet après quelques mois sans entretien, vous verrez ces dépôts blancs qui s'accumulent autour du bec. Ce qui est visible à l'extérieur est souvent bien pire à l'intérieur des canalisations.</p>
<p>Le <strong>TH (titre hydrotimétrique)</strong> de l'eau à Marrakech est généralement entre 30 et 45 °f (degrés français), ce qui la classe comme "très dure". À titre de comparaison, l'eau idéale pour les canalisations se situe entre 15 et 20 °f. Cette dureté extrême provoque :</p>
<ul>
<li>Une réduction progressive du diamètre intérieur des tuyaux (tartre qui s'accumule)</li>
<li>Une détérioration accélérée des chauffe-eau et ballons d'eau chaude</li>
<li>Des problèmes avec les lave-linge et lave-vaisselle</li>
<li>Des robinets et mitigeurs qui durcissent et finissent par se bloquer</li>
...
<p>Un conseil pratique : demandez toujours un devis écrit avant que le plombier commence les travaux, surtout pour les interventions importantes. Un bon professionnel n'hésitera pas à mettre son estimation par écrit.</p>`,
    ...
    {
      title: "Piscines et plomberie extérieure à Marrakech",
      content: `<p>Marrakech est probablement la ville marocaine avec la plus forte densité de piscines privées par habitant. Entre les riads avec leur petite piscine de 20-30m², les villas de la Palmeraie avec leurs bassins olympiques et les hôtels de luxe avec leurs complexes aquatiques, il y a une réelle expertise locale en plomberie de piscine.</p>
<p>Une piscine, c'est un système complexe qui comprend :</p>
<ul>
<li>Une pompe de circulation (à remplacer tous les 5-10 ans)</li>
<li>Un filtre à sable ou à diatomées (nettoyage par contre-lavage toutes les 2-3 semaines)</li>
<li>Un système de traitement de l'eau (chlore, sel, UV, ou combinaison)</li>
<li>Des skimmers et buses de refoulement</li>
<li>Souvent un système de chauffage (pompe à chaleur ou échangeur solaire)</li>
<li>Un système de vidange de fond</li>
</ul>
<p>En termes de tarifs pour la plomberie de piscine à Marrakech :</p>
<ul>
<li>Remplacement pompe de piscine (fourni + posé) : 1 200 à 3 500 DH selon puissance</li>
<li>Réparation fuite liner ou paroi : 800 à 2 500 DH</li>
<li>Remplacement filtre sable complet : 2 000 à 4 000 DH</li>
<li>Entretien mensuel piscine (maintenance complète) : 300 à 600 DH/mois</li>
<li>Mise en service après hivernage : 400 à 800 DH</li>
</ul>
<p>La <strong>plomberie d'irrigation</strong> est également importante à Marrakech pour les jardins et terrasses des villas. Les systèmes d'arrosage automatique avec programmateur, les micro-asperseurs et les goutteurs sont courants dans les propriétés haut de gamme. L'entretien de ces systèmes (débouchage des goutteurs calcifiés, remplacement des électrovannes) est un marché en pleine expansion.</p>
<p>Attention aux fuites sur les circuits d'irrigation enterrés : dans un jardin de Palmeraie, une fuite sur un tuyau enterré peut passer inaperçue pendant des mois et gonfler considérablement la facture RADEEMA. Si vous constatez une hausse anormale de votre consommation d'eau sans explication visible, faites vérifier votre réseau d'irrigation en priorité.</p>`,
    },
    {
...
<ul>
<li><strong>Canalisations bouchées</strong> : hôtels et riads avec beaucoup de rotation de clients accumulent les bouchons de cheveux, savon et calcaire dans les évacuations. Prévoir un débouchage préventif trimestriel.</li>
<li><strong>Fuites de robinetterie</strong> : avec des dizaines de robinets en service permanent, l'usure est plus rapide que dans un logement particulier. Un programme de remplacement préventif des joints et cartouches est recommandé.</li>
<li><strong>Problèmes de chauffe-eau collectif</strong> : les hôtels ont souvent de grands ballons d'eau chaude centraux. Un ballon en panne en pleine saison, c'est la catastrophe. Faire vérifier l'anode de protection et le thermostat chaque année.</li>
<li><strong>Pression d'eau insuffisante aux étages</strong> : problème classique dans les riads à 3-4 niveaux. Nécessite souvent l'installation d'un surpresseur.</li>
</ul>
<p>Un conseil pour les gérants d'établissements : <strong>établissez un contrat d'entretien annuel avec un plombier local de confiance</strong>, avec engagement d'intervention d'urgence sous 1-2 heures. Certains plombiers proposent des forfaits spéciaux pour l'hôtellerie qui incluent les visites préventives et une priorité d'intervention. Cela coûte entre 2 000 et 5 000 DH par an selon la taille de l'établissement et ça vaut vraiment l'investissement.</p>`,
    },
    {
...
<p>Pour signaler un problème ou consulter votre compte, le site RADEEMA est accessible sur <strong>radeema.ma</strong>, avec des espaces client pour suivre sa consommation et ses factures.</p>`,
  ...
  priceTable: [
    {
      intervention: "Débouchage lavabo / évier",
      prixMin: 150,
      prixMoyen: 250,
      prixMax: 400,
    },
    {
      intervention: "Débouchage WC (furet)",
      prixMin: 200,
      prixMoyen: 350,
      prixMax: 500,
    },
    {
      intervention: "Débouchage canalisation (haute pression)",
      prixMin: 400,
      prixMoyen: 600,
      prixMax: 1000,
    },
    {
      intervention: "Réparation fuite robinet / joint",
      prixMin: 100,
      prixMoyen: 200,
      prixMax: 350,
    },
    {
      intervention: "Remplacement robinetterie (fourni + posé)",
      prixMin: 300,
      prixMoyen: 500,
      prixMax: 900,
    },
    {
      intervention: "Remplacement WC suspendu (fourni + posé)",
      prixMin: 1200,
      prixMoyen: 1800,
      prixMax: 2800,
    },
    {
      intervention: "Réparation fuite canalisation encastrée",
      prixMin: 500,
      prixMoyen: 900,
      prixMax: 1800,
    },
    {
      intervention: "Installation chauffe-eau électrique 100L",
      prixMin: 1500,
      prixMoyen: 2200,
      prixMax: 3500,
    },
    {
      intervention: "Installation chauffe-eau solaire (fourni + posé)",
      prixMin: 4000,
      prixMoyen: 6500,
      prixMax: 10000,
    },
    {
      intervention: "Installation surpresseur eau",
      prixMin: 1200,
      prixMoyen: 2000,
      prixMax: 3500,
    },
    {
      intervention: "Installation adoucisseur d'eau",
      prixMin: 3500,
      prixMoyen: 5000,
      prixMax: 7000,
    },
    {
      intervention: "Remplacement pompe piscine",
      prixMin: 1200,
      prixMoyen: 2200,
      prixMax: 3500,
    },
    {
      intervention: "Réparation fuite piscine (liner/paroi)",
      prixMin: 800,
      prixMoyen: 1500,
      prixMax: 2500,
    },
    {
      intervention: "Entretien mensuel piscine",
      prixMin: 300,
      prixMoyen: 450,
      prixMax: 600,
    },
    {
      intervention: "Urgence plomberie nuit / week-end (déplacement)",
      prixMin: 300,
      prixMoyen: 500,
      prixMax: 800,
    },
    {
      intervention: "Installation citerne stockage eau (2000L)",
      prixMin: 3000,
      prixMoyen: 4500,
      prixMax: 6500,
    },
  ...
  externalLinks: [
    {
      label: "RADEEMA – Régie des eaux de Marrakech",
      url: "https://www.radeema.ma",
      description:
        "Signalement de fuites réseau public, espace client, coupures programmées et contacts urgences.",
    },
    {
      label: "Chambre d'Artisanat de Marrakech",
      url: "https://www.artisanat.ma/marrakech",
      description:
        "Trouver des artisans qualifiés et certifiés dans la région Marrakech-Safi.",
    },
    {
      label: "ONEE – Office National de l'Électricité et de l'Eau",
      url: "https://www.onee.ma",
      description:
        "Normes techniques nationales pour les installations d'eau et réglementation.",
    },
  ],
  ...
  testimonials: [
    {
      ...
      city: "Marrakech",
      rating: 5,
      text: "Fuite dans mon riad un vendredi soir, juste avant l'arrivée des clients du week-end. Le plombier est arrivé en 45 minutes, a localisé la fuite derrière un mur de la salle de bain, tout réparé proprement. Il a même refait le joint de la douche qui suintait depuis des mois. Sérieux et rapide.",
      date: "Janvier 2026",
      service: "Réparation fuite urgente riad",
    },
    {
      name: "Sophie L.",
      quarter: "Guéliz",
      city: "Marrakech",
      rating: 5,
      text: "J'ai racheté un appartement dans Guéliz que je rénove. Le plombier a refait entièrement la plomberie de la salle de bain et de la cuisine, avec de bons matériaux. Il m'a conseillé d'installer un adoucisseur dès le départ vu la qualité de l'eau ici. Bon conseil, je l'ai suivi.",
      date: "Février 2026",
      service: "Rénovation plomberie complète appartement",
    },
    {
      name: "Karim M.",
      quarter: "Palmeraie",
      city: "Marrakech",
      rating: 4,
      text: "Pompe de piscine en panne en plein été. Trouvé via Allo Maison, le prestataire connaissait bien les piscines, a remplacé la pompe et détartré le filtre. Prix correct pour une intervention d'urgence en haute saison. Je prends maintenant un contrat d'entretien mensuel.",
      date: "Août 2025",
      service: "Réparation pompe piscine urgence",
    },
    {
      name: "Fatima O.",
      quarter: "Massira",
      city: "Marrakech",
      rating: 5,
      text: "Chauffe-eau qui ne fonctionnait plus depuis 3 jours. Le technicien est venu le lendemain matin, a diagnostiqué la résistance grillée et le thermostat défaillant. Tout remplacé en 2 heures. Maintenant il chauffe parfaitement. Le devis était clair avant l'intervention.",
      date: "Décembre 2025",
      service: "Réparation chauffe-eau électrique",
    },
  ],

  faqs: [
    {
      question: "Combien coûte un plombier d'urgence à Marrakech la nuit ?",
      answer:
        "Pour une intervention nocturne (21h-7h), prévoyez une majoration de 50 à 100% sur le tarif normal. Le déplacement seul peut coûter entre 300 et 500 DH, auquel s'ajoute le tarif de l'intervention. En haute saison touristique, la disponibilité des bons plombiers est réduite, ce qui peut faire monter les prix. Ayez toujours le contact d'un plombier de confiance avant d'en avoir besoin.",
    },
    {
      question: "Mon riad a une pression d'eau très faible aux étages. Comment résoudre ça ?",
      answer:
        "C'est un problème très fréquent dans la Médina de Marrakech. La solution la plus efficace est l'installation d'un surpresseur avec ballon d'expansion. Un surpresseur adapté pour un riad de 6-8 chambres coûte entre 1 200 et 2 500 DH fourni et posé. Avant de passer à cette solution, vérifiez qu'il n'y a pas une vanne partiellement fermée sur le circuit ou des canalisations entartrées qui réduisent le débit.",
    },
    {
      question: "Qui contacter en cas de fuite dans une ruelle de la Médina ?",
      answer:
        "Si la fuite est sur la voie publique, contactez directement la RADEEMA au 0524-43-56-56. Si elle est à l'intérieur de votre propriété ou depuis votre branchement privé, c'est à vous de faire intervenir un plombier. En cas de doute, appelez quand même la RADEEMA qui peut vous orienter et confirmer de quel côté du compteur se situe la fuite.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Pour les travaux de plomberie intérieure courants (remplacement de tuyaux, installation sanitaires), aucun permis n'est requis. En revanche, si vous modifiez les colonnes montantes collectives dans un immeuble, ou si vous intervenez sur le branchement au réseau public, vous devez contacter la RADEEMA et potentiellement déposer une demande de travaux. Dans la Médina, tout projet de rénovation significatif peut nécessiter l'accord de la commune pour préserver le patrimoine.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Demandez des recommandations aux voisins ou au syndic de votre immeuble. Privilégiez les plombiers qui donnent un devis avant intervention. Méfiez-vous des tarifs anormalement bas qui cachent souvent un travail bâclé ou du matériel de mauvaise qualité. Via Allo Maison, les prestataires sont vérifiés et les avis clients disponibles pour vous aider à choisir en connaissance de cause.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "En tant que propriétaire d'un meublé de tourisme, vous avez l'obligation de fournir une installation sanitaire fonctionnelle et conforme aux normes d'hygiène. L'eau chaude doit être disponible en permanence. Il est recommandé de faire vérifier la conformité de votre installation par un professionnel avant de mettre en location, notamment pour les ballons d'eau chaude (risque de légionellose si la température n'est pas maintenue à 60°C minimum).",
    },
  ],
