...
const content: RichPageContent = {
  ...
  h1: "Plombier à Casablanca : intervention rapide, tarifs clairs, pros vérifiés",
  heroText:
    "Besoin d'un plombier de confiance à Casablanca ? Fuite d'eau, débouchage, installation sanitaire ou chauffe-eau, nos plombiers vérifiés interviennent rapidement dans tous les quartiers.",
...
<p><strong>Le devis verbal.</strong> Insistez toujours pour un devis écrit, même sur WhatsApp ou SMS. Un message écrit avec le montant et la description du travail suffit. En cas de litige, c'est votre seule protection.</p>`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Oui, si vous avez une fuite active sur un tuyau d'alimentation sous pression, fermez immédiatement le robinet d'arrêt le plus proche (sous l'évier, au compteur, etc.). Cela limite les dégâts et peut réduire nettement le coût de l'intervention. Pour une fuite sur l'évacuation (évier qui fuit vers le bas), il suffit de ne pas utiliser l'eau.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Les deux options existent. Un artisan sérieux a généralement en stock les pièces courantes (joints, flexibles, siphons, robinets d'arrêt). Pour les pièces spécifiques (chauffe-eau d'une marque particulière, robinetterie haut de gamme), il peut soit vous les commander soit vous donner la référence pour les acheter vous-même. En général, si vous fournissez les pièces, vous économisez 20-30% sur le total.",
    },
    {
  ...
  tips: [
    ...
    "Avant de gros travaux de plomberie, demandez toujours 2 devis minimum. Pas pour choisir le moins cher, pour comprendre pourquoi les prix diffèrent et ce que chaque artisan propose vraiment.",
