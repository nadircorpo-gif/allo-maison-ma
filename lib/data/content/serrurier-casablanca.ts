...
<p><strong>Les faux urgentistes</strong> : des individus qui répondent aux recherches Google "serrurier casablanca urgence" avec de faux sites, arrivent rapidement, et pratiquent des tarifs abusifs sachant que vous n'avez pas le choix.</p>
<p>Pour vous protéger :</p>
<ul>
  <li>Demandez toujours un devis <strong>par écrit ou confirmé clairement au téléphone</strong> avant toute intervention</li>
  <li>Vérifiez que le serrurier a un numéro marocain fixe et une adresse physique</li>
  <li>Préférez les artisans recommandés par le bouche-à-oreille ou votre gardien d'immeuble</li>
  <li>En cas de litige sur le prix, vous pouvez contacter le <strong>Bureau des réclamations de la Wilaya de Casablanca</strong></li>
  <li>Ne payez jamais 100% en avance</li>
</ul>
<p>Un bon indicateur : le serrurier qui arrive avec une facturette pré-remplie à des montants énormes avant même d'avoir vu votre porte, fuyez.</p>`,
    },
    {
...
<p>Autre ressource : votre assurance habitation. Beaucoup de contrats d'assurance habitation au Maroc (Wafa Assurance, RMA, SANAD) incluent une assistance serrurerie 24h/24. Vérifiez votre contrat — vous êtes peut-être couvert gratuitement.</p>`,
  ...
  priceTable: [
    { intervention: "Ouverture porte simple (cylindre standard)", prixMin: 150, prixMoyen: 250, prixMax: 350 },
    { intervention: "Ouverture porte blindée", prixMin: 400, prixMoyen: 600, prixMax: 900 },
    { intervention: "Changement serrure complète", prixMin: 300, prixMoyen: 500, prixMax: 800 },
    { intervention: "Remplacement cylindre (entrée de gamme)", prixMin: 180, prixMoyen: 280, prixMax: 400 },
    { intervention: "Remplacement cylindre (haute sécurité)", prixMin: 400, prixMoyen: 650, prixMax: 1000 },
    { intervention: "Blindage de porte (pose incluse)", prixMin: 3500, prixMoyen: 5500, prixMax: 8000 },
    { intervention: "Double de clé (cylindre standard)", prixMin: 30, prixMoyen: 50, prixMax: 100 },
    { intervention: "Serrure 3 points (fourniture + pose)", prixMin: 800, prixMoyen: 1200, prixMax: 2000 },
    { intervention: "Digicode / serrure connectée (pose)", prixMin: 600, prixMoyen: 1000, prixMax: 2500 },
  ...
  externalLinks: [
    ...
    {
      label: "Fédération Nationale des Artisans du Maroc",
  ...
  testimonials: [
    {
      ...
      city: "Casablanca",
      rating: 5,
      text: "Porte claquée un samedi soir, j'ai appelé via Allo Maison. Le serrurier était là en 25 minutes, très professionnel, m'a expliqué ce qu'il faisait. 280 DH pour l'ouverture, exactement ce qu'il m'avait annoncé. Je recommande.",
      date: "Mars 2026",
      service: "Ouverture de porte urgence",
    },
    {
      name: "Fatima Z.",
      quarter: "Gauthier",
      city: "Casablanca",
      rating: 5,
      text: "J'avais peur des arnaques donc j'ai demandé le prix avant. On m'a dit 350 DH pour changer le cylindre après perte de clés. Le serrurier est arrivé, a tout fait en 20 minutes. Facture conforme. C'est rassurant d'avoir un service fiable.",
      date: "Janvier 2026",
    ...
    },
    {
      ...
      city: "Casablanca",
      rating: 4,
      text: "Bonne intervention pour ma porte blindée. Un peu plus long que prévu (45 min au lieu de 30) mais le résultat est là. Prix correct pour une porte blindée. L'artisan m'a aussi conseillé sur le renforcement des gonds, ce qui était utile.",
      date: "Février 2026",
  ...
  faqs: [
    {
      question: "Combien coûte un serrurier la nuit à Casablanca ?",
      answer:
        "Entre 300 et 800 DH selon la complexité de l'intervention et votre quartier. Les tarifs de nuit (22h-7h) comportent une majoration de 50 à 100% par rapport aux prix de jour. C'est légal et normal. Demandez toujours le tarif total avant l'intervention.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Signaux d'alarme : il refuse de donner un prix ferme avant d'arriver, il arrive très vite (il était 'juste à côté' à 3h du matin), il vous dit que votre serrure est irréparable et doit être changée sans vous la montrer, il n'a pas de facturier officiel. Un vrai professionnel vous donne un prix clair, travaille méthodiquement, et vous explique ce qu'il fait.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Dans la grande majorité des cas, oui. Un serrurier professionnel dispose de crochets et d'outils de crochetage (picking) qui permettent d'ouvrir sans destruction. Sur les cylindres simples, c'est en général 5 à 10 minutes. Pour les cylindres haute sécurité (antibump), cela peut prendre plus longtemps ou nécessiter une technique différente.",
    },
    {
      question: "Quel est le délai d'intervention moyen à Casablanca ?",
      answer:
        "Dans les quartiers centraux (Maarif, Gauthier, Bourgogne, CIL, Ain Diab), comptez 20 à 35 minutes. Pour des quartiers périphériques comme Dar Bouazza, Bouskoura, Sidi Bernoussi ou Mohammedia, c'est souvent 45 minutes à 1 heure, surtout la nuit.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Entre 3 500 et 8 000 DH tout compris (porte + cylindre + pose), selon la marque et la classe de résistance. Les portes Fichet et Dierre sont les plus reconnues sur le marché marocain. Il existe aussi des marques locales moins chères (2 000 à 3 500 DH) mais avec une garantie et des performances inférieures.",
    },
    {
      question: "Qu'est-ce qu'un cylindre antibump et en ai-je besoin ?",
      answer:
        "Le bumping est une technique d'effraction qui consiste à utiliser une 'bump key' pour ouvrir rapidement n'importe quel cylindre standard. Un cylindre antibump est conçu pour résister à cette technique. À Casablanca, c'est surtout utile dans les quartiers exposés aux cambriolages. Comptez 200 à 400 DH de plus qu'un cylindre classique pour cette protection.",
    },
    {
      question: "Y a-t-il des serruriers agréés officiellement au Maroc ?",
      answer:
        "Il n'existe pas de certification nationale obligatoire pour les serruriers au Maroc comme dans certains pays européens. En revanche, les artisans membres de la Maison de l'Artisan ou inscrits à leur chambre professionnelle locale sont généralement plus fiables. Le bouche-à-oreille reste le meilleur critère de sélection.",
    },
  ],
